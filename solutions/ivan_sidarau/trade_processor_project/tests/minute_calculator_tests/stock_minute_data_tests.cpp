...
void minute_calculator::tests_::stock_minute_data_tests()
{
	...
	{
		stock_minute_data smd( trade_message::create_test_message( 12u, "ASD", 10.2, 15.3 ) );
		smd.add_trade( trade_message::create_test_message( 11u, "ASD", 13.1, 12.0 ) );
		smd.add_trade( trade_message::create_test_message( 14u, "ASD", 16.1, 18.0 ) );
		smd.add_trade( trade_message::create_test_message( 13u, "ASD", 9.1, 4.7 ) );
		smd.add_quote( quote_message::create_test_message( 190u, "ASD", 10.2, 15.3, 13.2, 13.7 ) );
		smd.add_quote( quote_message::create_test_message( 190u, "ASD", 10.2, 14.7, 13.2, 12.4 ) );
		std::stringstream test;
		test << smd;
