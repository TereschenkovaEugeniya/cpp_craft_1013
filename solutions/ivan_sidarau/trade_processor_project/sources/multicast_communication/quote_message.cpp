...
//
const boost::posix_time::ptime& multicast_communication::quote_message::message_time() const
{
	return message_time_;
}

boost::uint64_t multicast_communication::quote_message::minute() const
{
	return minute_;
}
