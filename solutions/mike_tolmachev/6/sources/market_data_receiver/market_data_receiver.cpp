...
const size_t market_data_receiver::default_buffer_size = 16ul;
...
void market_data_receiver::register_listen_( buffer_type pre_buffer, const size_t previous_size )
{
	buffer_type buffer;
...
void market_data_receiver::listen_handler_( buffer_type bt, const boost::system::error_code& error, const size_t bytes_received )
{
	if ( error )
	{
...
void market_data_receiver::enlarge_buffer_( buffer_type& bt )
{
